...
z	equ	0
pclath	equ	10
# 31 "H:\Aldnoah.Zero\trunk\Assignment3\Main.c"
...
l6850:	
;Main.c: 230: {
;Main.c: 231: pb1Pressed = 0;
	bcf	(_pb1Pressed/8),(_pb1Pressed)&7
	line	233
	
l6852:	
;Main.c: 233: rotate(2, 1);
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(?_rotate)^080h
	bsf	status,0
...
l6856:	
;Main.c: 237: {
;Main.c: 238: pb2Pressed = 0;
	bcf	(_pb2Pressed/8),(_pb2Pressed)&7
	line	240
	
l6858:	
;Main.c: 240: rotate(2, 0);
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(?_rotate)^080h
	movlw	(02h)
...
l6862:	
;Main.c: 244: {
;Main.c: 245: pb3Pressed = 0;
	bcf	(_pb3Pressed/8),(_pb3Pressed)&7
	line	247
	
l6864:	
;Main.c: 247: rotate(200, current_direction);
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l6866:	
;Main.c: 248: current_direction ^= 0x01;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(??_main+0)^080h+0
...
;; *************** function _init *****************
;; Defined at:
;;		line 179 in file "H:\Aldnoah.Zero\trunk\Assignment3\Main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l6830:	
;Main.c: 186: TRISC = 0x00;
	clrf	(135)^080h	;volatile
	line	189
	
l6832:	
;Main.c: 189: OPTION_REG = 0b00000100;
	movlw	(04h)
...
;; *************** function _rotate *****************
;; Defined at:
;;		line 26 in file "H:\Aldnoah.Zero\trunk\Assignment3\steppermotor.c"
;; Parameters:    Size  Location     Type
...
i1l6434:	
;Main.c: 98: if(RTC_Counter % 10 == 0) RTC_FLAG_10MS = 1;
	movlw	low(0Ah)
	movwf	(?___lwmod)
	movlw	high(0Ah)
	movwf	((?___lwmod))+1
...
i1l6444:	
;Main.c: 101: {
;Main.c: 102: ADCconvert(readAvgDistance());
...
i1l6460:	
;Main.c: 118: if(pb0DebounceCount >= 10 & pb0Released)
	movlw	(0Ah)
...
i1l6464:	
;Main.c: 119: {
;Main.c: 120: pb0Pressed = 1;
	bsf	(_pb0Pressed/8),(_pb0Pressed)&7
	line	121
;Main.c: 121: pb0Released = 0;
...
;Main.c: 124: else
;Main.c: 125: {
;Main.c: 126: pb0DebounceCount = 0;
	clrf	(_pb0DebounceCount)	;volatile
	line	127
;Main.c: 127: pb0Released = 1;
...
i1l6468:	
;Main.c: 134: if(pb1DebounceCount >= 10 & pb1Released)
	movlw	(0Ah)
...
i1l6472:	
;Main.c: 135: {
;Main.c: 136: pb1Pressed = 1;
	bsf	(_pb1Pressed/8),(_pb1Pressed)&7
	line	137
;Main.c: 137: pb1Released = 0;
...
;Main.c: 140: else
;Main.c: 141: {
;Main.c: 142: pb1DebounceCount = 0;
	clrf	(_pb1DebounceCount)	;volatile
	line	143
;Main.c: 143: pb1Released = 1;
...
i1l6476:	
;Main.c: 149: if(pb2DebounceCount >= 10 & pb2Released)
	movlw	(0Ah)
...
i1l6480:	
;Main.c: 150: {
;Main.c: 151: pb2Pressed = 1;
	bsf	(_pb2Pressed/8),(_pb2Pressed)&7
	line	152
;Main.c: 152: pb2Released = 0;
...
;Main.c: 155: else
;Main.c: 156: {
;Main.c: 157: pb2DebounceCount = 0;
	clrf	(_pb2DebounceCount)	;volatile
	line	158
;Main.c: 158: pb2Released = 1;
...
i1l6484:	
;Main.c: 164: if(pb3DebounceCount >= 10 & pb3Released)
	movlw	(0Ah)
...
i1l6488:	
;Main.c: 165: {
;Main.c: 166: pb3Pressed = 1;
	bsf	(_pb3Pressed/8),(_pb3Pressed)&7
	line	167
;Main.c: 167: pb3Released = 0;
...
;Main.c: 170: else
;Main.c: 171: {
;Main.c: 172: pb3DebounceCount = 0;
	clrf	(_pb3DebounceCount)	;volatile
	line	173
;Main.c: 173: pb3Released = 1;
