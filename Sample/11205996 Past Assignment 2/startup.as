	...
	; Compiler options:
	;
	; -oAssignment2Sensing.cof -mAssignment2Sensing.map --summary=default \
	; --output=default initialise.p1 Main.p1 adc.p1 lcd.p1 --chip=16F877A \
	; -P --runtime=default --opt=default -D__DEBUG=1 --debugger=icd2 -g \
